...
class ApiController extends Controller {
    ...
    public static function getLanguages() {
        $languages = Language::where('status', 'enable')->get();
        $languageList = [
            'type' => 'select',
            'title' => trans('Common.language'),
            'rules' => '',
            'defaule' => App::getLocale(),
        ];
        foreach ($languages as $language) {
            $languageList['options'][$language->language_code] = [
                'id' => $language->id,
                'title' => trans('Common.' . $language->language_code),
                'flag' => [
                    'url' => url('') . '/public/' . config('configuration.LanguageImages') . '/' . $language->language_icon,
                    'method' => 'get'
                ]
            ];
        }
