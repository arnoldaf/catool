    ...
    if($('body').data('page') == 'login'){
        ...
        $('#submit-form, #submit-password').click(function(e) {
            ...
            var _form = $(".form-signin"),
                _msgDiv = _form.find('.resp-msg'),
                formData = $('.form-signin').serialize();
            
            if (_form.find('#email').val() == '') {
                _msgDiv.removeClass('hide').html('Email or Mobile no. is required');
                _form.find('#email').focus();
                loader.stop();
                return;
            }
            if (_form.find('#password').val() == '') {
                _msgDiv.removeClass('hide').html('Password is required');
                _form.find('#password').focus();
                loader.stop();
                return;
            }          
            $.ajax({
                ...
                success: function(resp) {
                    if (resp.result) {
                        ...
                        _msgDiv.removeClass('hide').html(resp.msg);
                    }
                    loader.stop();
                }
            });
