...
'1'=>'Individual ','2'=>'Sole Proprietorship','3'=>'HUF (Hindu Undivided Family)','4'=>'AOP ( Association of Person )','5'=>'BOI ( Body of Individual )','6'=>'Limited Liability Partnership Firm','cs'=>'Private Limited Company','7'=>'Public Company'),'Individual') }}
                                                                ...
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" name="client_type[]" value="1" data-checkbox="icheckbox_square-blue"> Individual
                                                                    </label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" name="client_type[]" value="2" data-checkbox="icheckbox_square-blue"> Sole Proprietorship
                                                                    </label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" name="client_type[]" value="3" data-checkbox="icheckbox_square-blue"> HUF (Hindu Undivided Family)
                                                                    </label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" name="client_type[]" value="4" data-checkbox="icheckbox_square-blue"> AOP ( Association of Person )
                                                                    </label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" name="client_type[]" value="5" data-checkbox="icheckbox_square-blue"> AOP ( Association of Person )
                                                                    </label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" name="client_type[]" value="6" data-checkbox="icheckbox_square-blue"> BOI ( Body of Individual )
                                                                    </label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" name="client_type[]" value="7" data-checkbox="icheckbox_square-blue"> Limited Liability Partnership Firm
                                                                    </label>
                                                                </div>

                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" name="client_type[]" value="8" data-checkbox="icheckbox_square-blue"> Private Limited Company
                                                                    </label>
                                                                </div>
                                                ...
                                                <div class="text-center  m-t-20">
                                                    {{ Form::submit('Save', array('class' => 'btn btn-embossed btn-primary')) }}
