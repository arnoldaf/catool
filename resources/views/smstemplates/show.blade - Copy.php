        ...
        <section>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="header">
                        <h2>Email Template <strong>{{$emailtemplate->subject}}</strong></h2>
					...
					<div class="col-md-6">
                      <h4><strong>Showing {{ $emailtemplate->subject }}</strong></h4>
                      <h3><strong>Created At:</strong> {{ $emailtemplate->created_at }}</h3>
					  <h3><strong>Body:</strong> {{ $emailtemplate->body }}</h3>
					  <p>&nbsp;</p>
					  <p>&nbsp;</p>
					  <p>&nbsp;</p>
					  <p>&nbsp;</p>
