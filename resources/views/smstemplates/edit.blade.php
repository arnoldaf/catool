						...
						<div class="col-md-12 portlets">
						  <div class="panel">
							<div class="panel-header panel-controls">
							  <h3><i class="icon-note"></i> <strong>Edit</strong> SMS Templates</h3>
							</div>
							
							 <!-- if there are creation errors, they will show here -->
							
						
							{{ Form::model($smstemplate, array('route' => array('smstemplates.update', $smstemplate->id), 'method' => 'PUT')) }}
							...
							<div class="panel-content">
							  ...
							  <div class="row">
								<div class="col-md-9" >
								  ...
								  {{ Form::text('subject', isset($smstemplate['subject'])? $smstemplate['subject'] : '',array('id'=>'','class'=>'form-control form-white','placeholder'=>'Subject')) }}
								  {{ Form::hidden('id', isset($smstemplate['id'])? $smstemplate['id'] : '',array('id'=>'','class'=>'form-control ')) }}
										
								</div>
								
								<div class="col-md-6">
								  <h3>Message <strong>Body</strong></h3>
								  <!--<textarea class="summernote" name="body"></textarea>-->
								  {{ Form::textarea('sms_body', isset($smstemplate['sms_body'])? $smstemplate['sms_body'] : '',array('id'=>'','class'=>'form-control form-white','placeholder'=>'SMS Body')) }}
