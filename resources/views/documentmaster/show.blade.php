							...
							<div class="panel-content">
							  ...
							  <div class="row">
								...
								<div class="col-md-6">
								  ...
								  {{$documentmaster['description']}}
								</div>
								
								<div class="col-sm-9 col-sm-offset-3">
									<div class="pull-left">
									<p>&nbsp;</p>
									 <a href="{{ URL::to('documentmaster') }}"> <button type="button" class="btn btn-embossed btn-primary m-r-20"><< Go Back</button></a>
									</div>
								  </div>
