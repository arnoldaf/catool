    ...
    <ul class="header-menu nav navbar-nav">
        ...
        <li class="dropdown" id="language-header">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a href="#" data-lang="en"><img src="{{URL::asset('assets/global/images/flags/usa.png')}}" alt="flag-english"> <span>English</span></a>
                </li>
                <li>
                    <a href="#" data-lang="es"><img src="{{URL::asset('assets/global/images/flags/spanish.png')}}" alt="flag-english"> <span>Español</span></a>
                </li>
                <li>
                    <a href="#" data-lang="fr"><img src="{{URL::asset('assets/global/images/flags/french.png')}}" alt="flag-english"> <span>Français</span></a>
                </li>
            </ul>
        </li>
        <!-- END USER DROPDOWN -->
                    ...
                    <ul class="dropdown-menu-list withScroll" data-height="220">
                        <li class="clearfix">
                            <span class="pull-left p-r-5">
                                <img src="{{URL::asset('assets/global/images/avatars/avatar3.png')}}" alt="avatar 3">
                            </span>
                            <div class="clearfix">
                                <div>
                        ...
                        <li class="clearfix">
                            <span class="pull-left p-r-5">
                                <img src="{{URL::asset('assets/global/images/avatars/avatar5.png')}}" alt="avatar 5">
                            </span>
                            <div class="clearfix">
                                <div>
                        ...
                        <li class="clearfix">
                            <span class="pull-left p-r-5">
                                <img src="{{URL::asset('assets/global/images/avatars/avatar6.png')}}" alt="avatar 6">
                            </span>
                            <div class="clearfix">
                                <div>
